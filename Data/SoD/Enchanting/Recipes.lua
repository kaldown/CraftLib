-- Data/SoD/Enchanting/Recipes.lua
-- Enchanting recipes for SoD Classic
...
local recipes = {
    ...
    -- Scroll of Spatial Mending (120)
    {
        id = 448624,
        name = "Scroll of Spatial Mending",
        itemId = 220792,
        skillRequired = 120,
        skillRange = { orange = 0, yellow = 120, green = 125, gray = 130 },
        reagents = {
            { itemId = 4470, name = "Simple Wood", count = 1 },
            { itemId = 10940, name = "Strange Dust", count = 4 },
        },
    ...
    -- Enchant Weapon - Dismantle (200)
    {
        id = 435481,
        name = "Enchant Weapon - Dismantle",
        skillRequired = 200,
        skillRange = { orange = 0, yellow = 200, green = 217, gray = 235 },
        reagents = {
            { itemId = 11174, name = "Lesser Nether Essence", count = 4 },
            { itemId = 5637, name = "Large Fang", count = 2 },
            { itemId = 11177, name = "Small Radiant Shard", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchant Chest - Retricutioner (200)
    {
        id = 435903,
        name = "Enchant Chest - Retricutioner",
        skillRequired = 200,
        skillRange = { orange = 0, yellow = 200, green = 220, gray = 240 },
        reagents = {
    ...
    -- Sigil of Innovation (225)
    {
        id = 439156,
        name = "Sigil of Innovation",
        itemId = 217308,
        skillRequired = 225,
        skillRange = { orange = 0, yellow = 225, green = 227, gray = 230 },
        reagents = {
            { itemId = 11137, name = "Vision Dust", count = 5 },
        },
        source = {
    ...
    -- Conductive Shield Coating (285)
    {
        ...
        reagents = {
            { itemId = 16204, name = "Illusion Dust", count = 2 },
    ...
    -- Sigil of Flowing Waters (305)
    {
        id = 463866,
        name = "Sigil of Flowing Waters",
        itemId = 228978,
        skillRequired = 305,
        skillRange = { orange = 0, yellow = 305, green = 312, gray = 320 },
        reagents = {
            { itemId = 16204, name = "Illusion Dust", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Magnificent Trollshine (310)
    {
        ...
        reagents = {
            { itemId = 8151, name = "Flask of Mojo", count = 3 },
            { itemId = 8152, name = "Flask of Big Mojo", count = 3 },
            { itemId = 14344, name = "Large Brilliant Shard", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
    ...
    -- Enchant Shield - Law of Nature (320)
    {
        id = 463871,
        name = "Enchant Shield - Law of Nature",
        skillRequired = 320,
        skillRange = { orange = 0, yellow = 320, green = 340, gray = 360 },
        reagents = {
            { itemId = 14344, name = "Large Brilliant Shard", count = 4 },
            { itemId = 16203, name = "Greater Eternal Essence", count = 12 },
            { itemId = 7078, name = "Essence of Fire", count = 4 },
    ...
    -- Speedstone (320)
    {
        ...
        skillRange = { orange = 0, yellow = 320, green = 340, gray = 360 },
        reagents = {
            { itemId = 234006, name = "Monstrous Silithid Chitin", count = 10 },
            { itemId = 234010, name = "Ancient Sandworm Bile", count = 10 },
            { itemId = 20725, name = "Nexus Crystal", count = 6 },
            { itemId = 234004, name = "Obsidian Grinding Stone", count = 6 },
            { itemId = 2452, name = "Swiftthistle", count = 20 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Tear of the Dreamer (320)
    {
        ...
        reagents = {
            ...
            { itemId = 234012, name = "Hive Thistle", count = 10 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Lodestone of Retaliation (320)
    {
        ...
        skillRange = { orange = 0, yellow = 320, green = 340, gray = 360 },
        reagents = {
            { itemId = 234007, name = "Spiked Silithid Chitin", count = 10 },
            { itemId = 234010, name = "Ancient Sandworm Bile", count = 5 },
            { itemId = 20725, name = "Nexus Crystal", count = 4 },
            { itemId = 234003, name = "Obsidian-Infused Thorium Bar", count = 10 },
            { itemId = 234011, name = "Qiraji Stalker Venom", count = 10 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchanted Stopwatch (320)
    {
        ...
        reagents = {
            ...
            { itemId = 234005, name = "Obsidian Blasting Powder", count = 6 },
            { itemId = 14344, name = "Large Brilliant Shard", count = 4 },
            { itemId = 2459, name = "Swiftness Potion", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchanted Repellent (320)
    {
        ...
        skillRange = { orange = 0, yellow = 320, green = 340, gray = 360 },
        reagents = {
            { itemId = 234011, name = "Qiraji Stalker Venom", count = 3 },
            { itemId = 234012, name = "Hive Thistle", count = 3 },
            { itemId = 16204, name = "Illusion Dust", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Enchant Chest - Living Stats (320)
    {
        id = 1213616,
        ...
        reagents = {
            ...
            { itemId = 13458, name = "Greater Nature Protection Potion", count = 10 },
            { itemId = 234011, name = "Qiraji Stalker Venom", count = 2 },
            { itemId = 234010, name = "Ancient Sandworm Bile", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchant Gloves - Holy Power (320)
    {
        ...
        reagents = {
            { itemId = 20725, name = "Nexus Crystal", count = 2 },
            { itemId = 14344, name = "Large Brilliant Shard", count = 5 },
            { itemId = 13180, name = "Stratholme Holy Water", count = 5 },
            { itemId = 12735, name = "Frayed Abomination Stitching", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchant Gloves - Arcane Power (320)
    {
        id = 1213626,
    ...
    -- Enchanted Prayer Tome (320)
    {
        ...
        reagents = {
            { itemId = 20725, name = "Nexus Crystal", count = 3 },
            { itemId = 234008, name = "Qiraji Silk", count = 10 },
            { itemId = 234003, name = "Obsidian-Infused Thorium Bar", count = 2 },
    ...
    -- Enchanted Totem (320)
    {
        ...
        reagents = {
            ...
            { itemId = 234012, name = "Hive Thistle", count = 10 },
            { itemId = 234003, name = "Obsidian-Infused Thorium Bar", count = 2 },
            { itemId = 12810, name = "Enchanted Leather", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchanted Mushroom (320)
    {
        ...
        reagents = {
            { itemId = 20725, name = "Nexus Crystal", count = 2 },
            { itemId = 234012, name = "Hive Thistle", count = 20 },
            { itemId = 12810, name = "Enchanted Leather", count = 3 },
            { itemId = 234011, name = "Qiraji Stalker Venom", count = 4 },
            { itemId = 234010, name = "Ancient Sandworm Bile", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Totem of Pyroclastic Thunder (320)
    {
        id = 1216014,
    ...
    -- Totem of Thunderous Strikes (320)
    {
        id = 1216016,
    ...
    -- Enchant Bracer - Spell Power (320)
    {
        id = 1217189,
    ...
    -- Enchant Off-Hand - Superior Intellect (320)
    {
        id = 1219577,
        ...
        reagents = {
            { itemId = 20725, name = "Nexus Crystal", count = 2 },
            { itemId = 16204, name = "Illusion Dust", count = 18 },
            { itemId = 7082, name = "Essence of Air", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Enchant Off-Hand - Excellent Spirit (320)
    {
        id = 1219578,
    ...
    -- Enchant 2H Weapon - Spellblasting (320)
    {
        id = 1219580,
        ...
        reagents = {
            { itemId = 20725, name = "Nexus Crystal", count = 3 },
            { itemId = 16204, name = "Illusion Dust", count = 24 },
            { itemId = 12938, name = "Blood of Heroes", count = 1 },
            { itemId = 8831, name = "Purple Lotus", count = 6 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Enchanting Trainer",
    ...
    -- Enchant Shield - Excellent Stamina (320)
    {
        id = 1219581,
    ...
    -- Enchant Gloves - Superior Strength (320)
    {
        id = 1219586,
        ...
        skillRange = { orange = 0, yellow = 320, green = 340, gray = 360 },
        reagents = {
            { itemId = 16203, name = "Greater Eternal Essence", count = 7 },
            { itemId = 16204, name = "Illusion Dust", count = 21 },
            { itemId = 7078, name = "Essence of Fire", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Enchant Cloak - Agility (320)
    {
        ...
        reagents = {
            { itemId = 16203, name = "Greater Eternal Essence", count = 3 },
            { itemId = 16204, name = "Illusion Dust", count = 9 },
            { itemId = 7078, name = "Essence of Fire", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Enchant Shield - Critical Strike (320)
    {
        id = 1220623,
    ...
    -- Enchant Bracer - Greater Spellpower (320)
    {
        id = 1220624,
