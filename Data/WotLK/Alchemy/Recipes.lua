-- Data/WotLK/Alchemy/Recipes.lua
-- Alchemy recipes for WotLK Classic
...
local recipes = {
    ...
    -- Major Troll's Blood Elixir (180)
    {
        id = 3451,
    ...
    -- Mighty Troll's Blood Elixir (290)
    {
        id = 24368,
    ...
    -- Resurgent Healing Potion (350)
    {
        ...
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Major Mageblood (355)
    {
        ...
        itemId = 22840,
        skillRequired = 355,
        skillRange = { orange = 355, yellow = 370, green = 375, gray = 380 },
        reagents = {
            { itemId = 22790, name = "Ancient Lichen", count = 1 },
            { itemId = 22791, name = "Netherbloom", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
    ...
    -- Wrath Elixir (355)
    {
        ...
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 37921, name = "Deadnettle", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Major Fire Protection Potion (360)
    {
        ...
        itemId = 22841,
        skillRequired = 360,
        skillRange = { orange = 360, yellow = 375, green = 377, gray = 380 },
        reagents = {
            { itemId = 21884, name = "Primal Fire", count = 1 },
    ...
    -- Icy Mana Potion (360)
    {
        ...
        itemId = 40067,
        skillRequired = 360,
        skillRange = { orange = 360, yellow = 365, green = 375, gray = 385 },
        reagents = {
            { itemId = 36907, name = "Talandra's Rose", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Spellpower Elixir (365)
    {
        ...
        itemId = 40070,
        skillRequired = 365,
        skillRange = { orange = 365, yellow = 375, green = 382, gray = 390 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 36904, name = "Tiger Lily", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Transmute: Primal Shadow to Water (375)
    {
        id = 28580,
        name = "Transmute: Primal Shadow to Water",
        itemId = 21885,
        skillRequired = 375,
        skillRange = { orange = 0, yellow = 375, green = 377, gray = 380 },
        reagents = {
            { itemId = 22456, name = "Primal Shadow", count = 1 },
        },
        source = {
    ...
    -- Transmute: Primal Water to Shadow (375)
    {
        id = 28581,
    ...
    -- Transmute: Primal Mana to Fire (375)
    {
        id = 28582,
    ...
    -- Transmute: Primal Fire to Mana (375)
    {
        id = 28583,
    ...
    -- Transmute: Primal Life to Earth (375)
    {
        id = 28584,
    ...
    -- Transmute: Primal Earth to Life (375)
    {
        id = 28585,
    ...
    -- Flask of Mighty Restoration (375)
    {
        id = 28588,
    ...
    -- Flask of Relentless Assault (375)
    {
        id = 28589,
    ...
    -- Pygmy Oil (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 40199, name = "Pygmy Suckerfish", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Guru's Elixir (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 40195, name = "Pygmy Oil", count = 3 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Lesser Flask of Toughness (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 37921, name = "Deadnettle", count = 4 },
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
    ...
    -- Ethereal Oil (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 41814, name = "Glassfin Minnow", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Potion of Nightmares (380)
    {
        ...
        itemId = 40081,
        skillRequired = 380,
        skillRange = { orange = 380, yellow = 385, green = 390, gray = 395 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 36907, name = "Talandra's Rose", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
    ...
    -- Elixir of Spirit (385)
    {
        ...
        reagents = {
            { itemId = 36907, name = "Talandra's Rose", count = 3 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Mighty Strength (385)
    {
        ...
        skillRange = { orange = 385, yellow = 390, green = 395, gray = 400 },
        reagents = {
            { itemId = 36904, name = "Tiger Lily", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Lesser Flask of Resistance (385)
    {
        id = 62213,
        ...
        skillRange = { orange = 385, yellow = 390, green = 395, gray = 400 },
        reagents = {
            { itemId = 39970, name = "Fire Leaf", count = 4 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Mighty Fortitude (390)
    {
        ...
        itemId = 40078,
        skillRequired = 390,
        skillRange = { orange = 390, yellow = 395, green = 400, gray = 405 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 4 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Mighty Agility (395)
    {
        ...
        itemId = 39666,
        skillRequired = 395,
        skillRange = { orange = 395, yellow = 400, green = 407, gray = 415 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 2 },
            { itemId = 36903, name = "Adder's Tongue", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Indestructible Potion (395)
    {
        ...
        itemId = 40093,
        skillRequired = 395,
        skillRange = { orange = 395, yellow = 415, green = 422, gray = 430 },
        reagents = {
            { itemId = 36906, name = "Icethorn", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Transmute: Titanium (395)
    {
        ...
        itemId = 41163,
        skillRequired = 395,
        skillRange = { orange = 395, yellow = 420, green = 430, gray = 440 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 8 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Elixir of Mighty Thoughts (395)
    {
        ...
        reagents = {
            { itemId = 37921, name = "Deadnettle", count = 2 },
            { itemId = 36907, name = "Talandra's Rose", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Crazy Alchemist's Potion (400)
    {
        id = 53895,
        name = "Crazy Alchemist's Potion",
        itemId = 40077,
        skillRequired = 400,
        skillRange = { orange = 400, yellow = 415, green = 422, gray = 430 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
    ...
    -- Powerful Rejuvenation Potion (400)
    {
        id = 53904,
        ...
        reagents = {
            { itemId = 36907, name = "Talandra's Rose", count = 2 },
            { itemId = 36905, name = "Lichbloom", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Mighty Arcane Protection Potion (400)
    {
        id = 53936,
        name = "Mighty Arcane Protection Potion",
        itemId = 40213,
        skillRequired = 400,
        skillRange = { orange = 400, yellow = 410, green = 415, gray = 420 },
        reagents = {
    ...
    -- Mighty Frost Protection Potion (400)
    {
        id = 53937,
        ...
        skillRange = { orange = 400, yellow = 410, green = 415, gray = 420 },
        reagents = {
            { itemId = 37702, name = "Crystallized Fire", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
    ...
    -- Mighty Shadow Protection Potion (400)
    {
        id = 53938,
        ...
        skillRange = { orange = 400, yellow = 410, green = 415, gray = 420 },
        reagents = {
            { itemId = 37704, name = "Crystallized Life", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
    ...
    -- Mighty Fire Protection Potion (400)
    {
        id = 53939,
        ...
        skillRange = { orange = 400, yellow = 410, green = 415, gray = 420 },
        reagents = {
            { itemId = 37705, name = "Crystallized Water", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
    ...
    -- Mighty Nature Protection Potion (400)
    {
        id = 53942,
    ...
    -- Elixir of Protection (400)
    {
        ...
        reagents = {
            { itemId = 36906, name = "Icethorn", count = 2 },
            { itemId = 37701, name = "Crystallized Earth", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Potion of Speed (400)
    {
        ...
        reagents = {
            { itemId = 36903, name = "Adder's Tongue", count = 2 },
            { itemId = 40195, name = "Pygmy Oil", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Mighty Mageblood (400)
    {
        id = 56519,
    ...
    -- Elixir of Mighty Defense (400)
    {
        ...
        reagents = {
            { itemId = 36906, name = "Icethorn", count = 2 },
            { itemId = 37704, name = "Crystallized Life", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Elixir of Lightning Speed (400)
    {
        ...
        skillRange = { orange = 400, yellow = 415, green = 422, gray = 430 },
        reagents = {
            { itemId = 37921, name = "Deadnettle", count = 1 },
            { itemId = 37704, name = "Crystallized Life", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
        },
        source = {
    ...
    -- Mercurial Alchemist Stone (400)
    {
        ...
        itemId = 44322,
        skillRequired = 400,
        skillRange = { orange = 400, yellow = 420, green = 425, gray = 430 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 20 },
            { itemId = 35625, name = "Eternal Life", count = 2 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Indestructible Alchemist Stone (400)
    {
        ...
        skillRange = { orange = 400, yellow = 420, green = 425, gray = 430 },
        reagents = {
            { itemId = 37921, name = "Deadnettle", count = 20 },
            { itemId = 40195, name = "Pygmy Oil", count = 12 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Mighty Alchemist Stone (400)
    {
        ...
        skillRange = { orange = 400, yellow = 420, green = 425, gray = 430 },
        reagents = {
            { itemId = 36903, name = "Adder's Tongue", count = 15 },
            { itemId = 36904, name = "Tiger Lily", count = 15 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Northrend Alchemy Research (400)
    {
        ...
        skillRange = { orange = 400, yellow = 415, green = 422, gray = 430 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 10 },
            { itemId = 36903, name = "Adder's Tongue", count = 10 },
            { itemId = 36907, name = "Talandra's Rose", count = 4 },
            { itemId = 40411, name = "Enchanted Vial", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Transmute: Eternal Life to Shadow (405)
    {
        id = 53771,
        name = "Transmute: Eternal Life to Shadow",
        itemId = 35627,
        skillRequired = 405,
        skillRange = { orange = 0, yellow = 405, green = 415, gray = 425 },
        reagents = {
    ...
    -- Transmute: Eternal Life to Fire (405)
    {
        id = 53773,
    ...
    -- Transmute: Eternal Fire to Water (405)
    {
        id = 53774,
    ...
    -- Transmute: Eternal Fire to Life (405)
    {
        id = 53775,
    ...
    -- Transmute: Eternal Air to Water (405)
    {
        id = 53776,
    ...
    -- Transmute: Eternal Air to Earth (405)
    {
        id = 53777,
    ...
    -- Transmute: Eternal Shadow to Earth (405)
    {
        id = 53779,
    ...
    -- Transmute: Eternal Shadow to Life (405)
    {
        id = 53780,
    ...
    -- Transmute: Eternal Earth to Air (405)
    {
        id = 53781,
    ...
    -- Transmute: Eternal Earth to Shadow (405)
    {
        id = 53782,
    ...
    -- Transmute: Eternal Water to Air (405)
    {
        id = 53783,
    ...
    -- Transmute: Eternal Water to Fire (405)
    {
        id = 53784,
    ...
    -- Runic Healing Potion (405)
    {
        ...
        itemId = 33447,
        skillRequired = 405,
        skillRange = { orange = 405, yellow = 410, green = 417, gray = 425 },
        reagents = {
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 36906, name = "Icethorn", count = 2 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
    ...
    -- Runic Mana Potion (410)
    {
        ...
        itemId = 33448,
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 415, green = 422, gray = 430 },
        reagents = {
            { itemId = 36905, name = "Lichbloom", count = 2 },
            { itemId = 36901, name = "Goldclover", count = 1 },
            { itemId = 18256, name = "Imbued Vial", count = 1 },
    ...
    -- Endless Mana Potion (410)
    {
        ...
        itemId = 43570,
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 415, green = 417, gray = 420 },
        reagents = {
            { itemId = 33448, name = "Runic Mana Potion", count = 10 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Alchemy Trainer",
    ...
    -- Endless Healing Potion (410)
    {
        ...
        itemId = 43569,
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 410, green = 412, gray = 415 },
        reagents = {
            { itemId = 33447, name = "Runic Healing Potion", count = 10 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Flask of the North (425)
    {
        id = 67025,
        name = "Flask of the North",
        itemId = 47499,
        skillRequired = 425,
        skillRange = { orange = 425, yellow = 440, green = 445, gray = 450 },
        reagents = {
            { itemId = 36908, name = "Frost Lotus", count = 4 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Transmute: Skyflare Diamond (430)
    {
        ...
        itemId = 41266,
        skillRequired = 430,
        skillRange = { orange = 430, yellow = 440, green = 445, gray = 450 },
        reagents = {
    ...
    -- Flask of the Frost Wyrm (435)
    {
        ...
        itemId = 46376,
        skillRequired = 435,
        skillRange = { orange = 435, yellow = 450, green = 457, gray = 465 },
        reagents = {
            { itemId = 36906, name = "Icethorn", count = 5 },
            { itemId = 36905, name = "Lichbloom", count = 5 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
    ...
    -- Flask of Stoneblood (435)
    {
        ...
        skillRange = { orange = 435, yellow = 450, green = 457, gray = 465 },
        reagents = {
            { itemId = 36905, name = "Lichbloom", count = 7 },
            { itemId = 37704, name = "Crystallized Life", count = 3 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
    ...
    -- Flask of Endless Rage (435)
    {
        ...
        reagents = {
            { itemId = 36905, name = "Lichbloom", count = 7 },
            { itemId = 36901, name = "Goldclover", count = 3 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
        source = {
    ...
    -- Flask of Pure Mojo (435)
    {
        ...
        skillRange = { orange = 435, yellow = 450, green = 457, gray = 465 },
        reagents = {
            { itemId = 36906, name = "Icethorn", count = 7 },
            { itemId = 40195, name = "Pygmy Oil", count = 3 },
            { itemId = 36908, name = "Frost Lotus", count = 1 },
            { itemId = 40411, name = "Enchanted Vial", count = 1 },
        },
    ...
    -- Transmute: Cardinal Ruby (440)
    {
        id = 66659,
        name = "Transmute: Cardinal Ruby",
        itemId = 36919,
        skillRequired = 440,
        skillRange = { orange = 0, yellow = 440, green = 452, gray = 465 },
        reagents = {
            { itemId = 36860, name = "Eternal Fire", count = 1 },
