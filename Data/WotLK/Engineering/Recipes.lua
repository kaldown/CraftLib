-- Data/WotLK/Engineering/Recipes.lua
-- Engineering recipes for WotLK Classic
...
local recipes = {
    ...
    -- Salt Shaker (250)
    {
        ...
        reagents = {
            ...
            { itemId = 10558, name = "Gold Power Core", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Flying Machine (300)
    {
        ...
        reagents = {
            ...
            { itemId = 23781, name = "Elemental Blasting Powder", count = 20 },
            { itemId = 23783, name = "Handful of Fel Iron Bolts", count = 20 },
    ...
    -- Volatile Blasting Trigger (350)
    {
        ...
        itemId = 39690,
        skillRequired = 350,
        skillRange = { orange = 350, yellow = 366, green = 375, gray = 385 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 3 },
    ...
    -- Handful of Cobalt Bolts (350)
    {
        ...
        skillRange = { orange = 350, yellow = 360, green = 370, gray = 380 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Cobalt Frag Bomb (350)
    {
        ...
        itemId = 40771,
        skillRequired = 350,
        skillRange = { orange = 350, yellow = 375, green = 382, gray = 390 },
        reagents = {
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 2 },
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Turbo-Charged Flying Machine (375)
    {
        ...
        reagents = {
            { itemId = 23784, name = "Adamantite Frame", count = 4 },
    ...
    -- Hammer Pick (375)
    {
        ...
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 5 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Explosive Decoy (375)
    {
        ...
        reagents = {
            ...
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Overcharged Capacitor (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 4 },
    ...
    -- Frag Belt (380)
    {
        ...
        name = "Frag Belt",
        skillRequired = 380,
        skillRange = { orange = 380, yellow = 380, green = 382, gray = 385 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 8 },
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 8 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Flexweave Underlay (380)
    {
        ...
        skillRange = { orange = 380, yellow = 380, green = 382, gray = 385 },
        reagents = {
            { itemId = 33470, name = "Frostweave Cloth", count = 12 },
            { itemId = 39682, name = "Overcharged Capacitor", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Personal Electromagnetic Pulse Generator (390)
    {
        ...
        skillRequired = 390,
        skillRange = { orange = 390, yellow = 390, green = 392, gray = 395 },
        reagents = {
            { itemId = 39682, name = "Overcharged Capacitor", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Diamond-cut Refractor Scope (390)
    {
        ...
        itemId = 44739,
        skillRequired = 390,
        skillRange = { orange = 390, yellow = 400, green = 407, gray = 415 },
        reagents = {
            { itemId = 39683, name = "Froststeel Tube", count = 1 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Mark "S" Boomstick (400)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 10 },
            { itemId = 39683, name = "Froststeel Tube", count = 2 },
            { itemId = 39684, name = "Hair Trigger", count = 1 },
            { itemId = 40533, name = "Walnut Stock", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Hand-Mounted Pyro Rocket (400)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 6 },
    ...
    -- Reticulated Armor Webbing (400)
    {
        ...
        skillRange = { orange = 400, yellow = 400, green = 402, gray = 405 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 4 },
    ...
    -- Nitro Boosts (405)
    {
        ...
        reagents = {
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 6 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 6 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Box of Bombs (405)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 5 },
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Mammoth Cutters (410)
    {
        ...
        itemId = 41164,
        skillRequired = 410,
        skillRange = { orange = 0, yellow = 410, green = 412, gray = 420 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 1 },
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Healing Injector Kit (410)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 12 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Goblin Beam Welder (410)
    {
        ...
        reagents = {
            ...
            { itemId = 37705, name = "Crystallized Water", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Mind Amplification Dish (410)
    {
        id = 67839,
        name = "Mind Amplification Dish",
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 410, green = 415, gray = 420 },
        reagents = {
    ...
    -- Scrapbot Construction Kit (415)
    {
        id = 55252,
        name = "Scrapbot Construction Kit",
        itemId = 40769,
        skillRequired = 415,
        skillRange = { orange = 0, yellow = 415, green = 417, gray = 420 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 10 },
        },
        source = {
    ...
    -- Saronite Razorheads (415)
    {
        id = 56475,
        name = "Saronite Razorheads",
        itemId = 41165,
        skillRequired = 415,
        skillRange = { orange = 0, yellow = 415, green = 417, gray = 425 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Mechanized Snow Goggles (420)
    {
        ...
        itemId = 41112,
        skillRequired = 420,
        skillRange = { orange = 420, yellow = 425, green = 432, gray = 440 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 8 },
            { itemId = 33568, name = "Borean Leather", count = 2 },
    ...
    -- Sonic Booster (420)
    {
        ...
        itemId = 40767,
        skillRequired = 420,
        skillRange = { orange = 420, yellow = 435, green = 440, gray = 445 },
        reagents = {
            { itemId = 39683, name = "Froststeel Tube", count = 2 },
            { itemId = 39682, name = "Overcharged Capacitor", count = 4 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 2 },
    ...
    -- Noise Machine (420)
    {
        ...
        reagents = {
            { itemId = 39683, name = "Froststeel Tube", count = 2 },
            { itemId = 39682, name = "Overcharged Capacitor", count = 2 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 8 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Sun Scope (425)
    {
        ...
        itemId = 41146,
        skillRequired = 425,
        skillRange = { orange = 425, yellow = 430, green = 432, gray = 435 },
        reagents = {
            { itemId = 39683, name = "Froststeel Tube", count = 1 },
    ...
    -- Gnomish X-Ray Specs (425)
    {
        ...
        skillRange = { orange = 425, yellow = 430, green = 435, gray = 440 },
        reagents = {
            { itemId = 41163, name = "Titanium Bar", count = 6 },
    ...
    -- Global Thermal Sapper Charge (425)
    {
        ...
        itemId = 42641,
        skillRequired = 425,
        skillRange = { orange = 425, yellow = 425, green = 430, gray = 435 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 1 },
            { itemId = 39690, name = "Volatile Blasting Trigger", count = 1 },
        },
    ...
    -- Heartseeker Scope (430)
    {
        ...
        itemId = 41167,
        skillRequired = 430,
        skillRange = { orange = 430, yellow = 435, green = 445, gray = 455 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 10 },
    ...
    -- Gnomish Army Knife (435)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 10 },
            { itemId = 7005, name = "Skinning Knife", count = 1 },
            { itemId = 2901, name = "Mining Pick", count = 1 },
            { itemId = 5956, name = "Blacksmith Hammer", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Engineering Trainer",
    ...
    -- Wormhole Generator: Northrend (435)
    {
        id = 67920,
        name = "Wormhole Generator: Northrend",
        itemId = 48933,
        skillRequired = 435,
        skillRange = { orange = 435, yellow = 450, green = 455, gray = 460 },
        reagents = {
            { itemId = 41163, name = "Titanium Bar", count = 8 },
    ...
    -- Electroflux Sight Enhancers (440)
    {
        ...
        reagents = {
            { itemId = 41163, name = "Titanium Bar", count = 8 },
            { itemId = 38425, name = "Heavy Borean Leather", count = 4 },
            { itemId = 36921, name = "Autumn's Glow", count = 2 },
            { itemId = 35623, name = "Eternal Air", count = 4 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
        source = {
    ...
    -- Unbreakable Healing Amplifiers (440)
    {
        id = 62271,
    ...
    -- Armor Plated Combat Shotgun (450)
    {
        ...
        reagents = {
            { itemId = 41163, name = "Titanium Bar", count = 10 },
            { itemId = 36913, name = "Saronite Bar", count = 20 },
            { itemId = 35623, name = "Eternal Air", count = 15 },
            { itemId = 35622, name = "Eternal Water", count = 15 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
            { itemId = 40533, name = "Walnut Stock", count = 1 },
        },
        source = {
    ...
    -- Mechano-hog (450)
    {
        ...
        itemId = 41508,
        skillRequired = 450,
        skillRange = { orange = 450, yellow = 480, green = 485, gray = 490 },
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 12 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 40 },
            { itemId = 44128, name = "Arctic Fur", count = 2 },
            { itemId = 44499, name = "Salvaged Iron Golem Parts", count = 1 },
            { itemId = 44501, name = "Goblin-machined Piston", count = 8 },
            { itemId = 44500, name = "Elementium-plated Exhaust Pipe", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
            factionId = 1052,
            factionName = "Horde Expedition",
            level = "Exalted",
            itemId = 44502,
            cost = 4000000,
        },
    ...
    -- Nesingwary 4000 (450)
    {
        ...
        reagents = {
            { itemId = 41163, name = "Titanium Bar", count = 10 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
            { itemId = 36860, name = "Eternal Fire", count = 12 },
            { itemId = 35627, name = "Eternal Shadow", count = 12 },
            { itemId = 41146, name = "Sun Scope", count = 3 },
            { itemId = 40533, name = "Walnut Stock", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Jeeves (450)
    {
        ...
        skillRange = { orange = 450, yellow = 480, green = 485, gray = 490 },
        reagents = {
            { itemId = 18232, name = "Field Repair Bot 74A", count = 2 },
            { itemId = 34113, name = "Field Repair Bot 110G", count = 10 },
            { itemId = 40769, name = "Scrapbot Construction Kit", count = 20 },
            { itemId = 37663, name = "Titansteel Bar", count = 8 },
            { itemId = 36922, name = "King's Amber", count = 2 },
            { itemId = 39681, name = "Handful of Cobalt Bolts", count = 30 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
            itemId = 49050,
    ...
    -- Shatter Rounds (450)
    {
        ...
        itemId = 52020,
        skillRequired = 450,
        skillRange = { orange = 0, yellow = 450, green = 450, gray = 460 },
        reagents = {
