-- Data/WotLK/Tailoring/Recipes.lua
-- Tailoring recipes for WotLK Classic
...
local recipes = {
    ...
    -- Spidersilk Drape (125)
    {
        ...
        reagents = {
            ...
            { itemId = 3182, name = "Spider's Silk", count = 6 },
            { itemId = 2321, name = "Fine Thread", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Ghostweave Vest (275)
    {
        ...
        reagents = {
            { itemId = 14048, name = "Bolt of Runecloth", count = 2 },
            { itemId = 9210, name = "Ghost Dye", count = 3 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Bloodvine Vest (300)
    {
        ...
        reagents = {
            ...
            { itemId = 12804, name = "Powerful Mojo", count = 3 },
            { itemId = 14227, name = "Ironweb Spider Silk", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
    ...
    -- Bolt of Netherweave (300)
    {
        ...
        reagents = {
            { itemId = 21877, name = "Netherweave Cloth", count = 5 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Flying Carpet (300)
    {
        ...
        itemId = 44554,
        skillRequired = 300,
        skillRange = { orange = 300, yellow = 340, green = 345, gray = 350 },
        reagents = {
    ...
    -- Bolt of Frostweave (350)
    {
        ...
        itemId = 41510,
        skillRequired = 350,
        skillRange = { orange = 350, yellow = 370, green = 372, gray = 375 },
        reagents = {
            { itemId = 33470, name = "Frostweave Cloth", count = 5 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Frostwoven Shoulders (350)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 3 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Frostweave Net (360)
    {
        ...
        skillRange = { orange = 360, yellow = 370, green = 375, gray = 380 },
        reagents = {
            { itemId = 33470, name = "Frostweave Cloth", count = 6 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Frostwoven Robe (360)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 4 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Frostwoven Cowl (380)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 5 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Mystic Frostwoven Shoulders (385)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 7 },
            { itemId = 38426, name = "Eternium Thread", count = 4 },
    ...
    -- Mystic Frostwoven Wristwraps (385)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 5 },
            { itemId = 38426, name = "Eternium Thread", count = 4 },
            { itemId = 36783, name = "Northsea Pearl", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Mystic Frostwoven Robe (390)
    {
        ...
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 8 },
            { itemId = 38426, name = "Eternium Thread", count = 4 },
            { itemId = 36783, name = "Northsea Pearl", count = 1 },
        },
        source = {
    ...
    -- Duskweave Leggings (395)
    {
        ...
        itemId = 41548,
        skillRequired = 395,
        skillRange = { orange = 395, yellow = 405, green = 410, gray = 415 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 8 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
    ...
    -- Duskweave Belt (395)
    {
        ...
        itemId = 41543,
        skillRequired = 395,
        skillRange = { orange = 395, yellow = 400, green = 405, gray = 410 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 7 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
    ...
    -- Bolt of Imbued Frostweave (400)
    {
        ...
        itemId = 41511,
        skillRequired = 400,
        skillRange = { orange = 400, yellow = 400, green = 402, gray = 405 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 2 },
    ...
    -- Red Lumberjack Shirt (400)
    {
        ...
        itemId = 41248,
        skillRequired = 400,
        skillRange = { orange = 400, yellow = 400, green = 405, gray = 410 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 4 },
            { itemId = 2604, name = "Red Dye", count = 1 },
        },
    ...
    -- Shining Spellthread (400)
    {
        ...
        reagents = {
            ...
            { itemId = 42253, name = "Iceweb Spider Silk", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Duskweave Boots (400)
    {
        ...
        itemId = 41544,
        skillRequired = 400,
        skillRange = { orange = 0, yellow = 400, green = 410, gray = 420 },
        reagents = {
            { itemId = 41520, name = "Frostwoven Boots", count = 1 },
    ...
    -- Frostguard Drape (400)
    {
        ...
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 4 },
            { itemId = 42253, name = "Iceweb Spider Silk", count = 4 },
    ...
    -- Duskweave Robe (405)
    {
        ...
        itemId = 41549,
        skillRequired = 405,
        skillRange = { orange = 405, yellow = 415, green = 420, gray = 425 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 10 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Duskweave Gloves (405)
    {
        ...
        skillRange = { orange = 405, yellow = 415, green = 420, gray = 425 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 9 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Master's Spellthread (405)
    {
        ...
        skillRequired = 405,
        skillRange = { orange = 405, yellow = 405, green = 405, gray = 405 },
        reagents = {
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
    ...
    -- Duskweave Shoulders (410)
    {
        ...
        itemId = 41550,
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 420, green = 425, gray = 430 },
        reagents = {
            { itemId = 41510, name = "Bolt of Frostweave", count = 10 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
    ...
    -- Frostweave Bag (410)
    {
        ...
        itemId = 41599,
        skillRequired = 410,
        skillRange = { orange = 410, yellow = 430, green = 440, gray = 450 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 6 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Tailoring Trainer",
    ...
    -- Black Duskweave Leggings (415)
    {
        ...
        itemId = 41553,
        skillRequired = 415,
        skillRange = { orange = 415, yellow = 425, green = 430, gray = 435 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 5 },
            { itemId = 42253, name = "Iceweb Spider Silk", count = 2 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
        },
        source = {
    ...
    -- Moonshroud (415)
    {
        ...
        skillRange = { orange = 415, yellow = 425, green = 430, gray = 435 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 1 },
    ...
    -- Wispcloak (415)
    {
        ...
        itemId = 41609,
        skillRequired = 415,
        skillRange = { orange = 415, yellow = 435, green = 445, gray = 455 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 5 },
    ...
    -- Frostsavage Belt (415)
    {
        ...
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 3 },
            { itemId = 37702, name = "Crystallized Fire", count = 3 },
            { itemId = 37701, name = "Crystallized Earth", count = 3 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Lightweave Embroidery (420)
    {
        ...
        skillRequired = 420,
        skillRange = { orange = 0, yellow = 0, green = 0, gray = 420 },
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 1 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Darkglow Embroidery (420)
    {
        ...
        skillRange = { orange = 0, yellow = 0, green = 0, gray = 420 },
        reagents = {
            { itemId = 41593, name = "Ebonweave", count = 1 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Swordguard Embroidery (420)
    {
        ...
        skillRange = { orange = 0, yellow = 0, green = 0, gray = 420 },
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 1 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Black Duskweave Robe (420)
    {
        ...
        itemId = 41554,
        skillRequired = 420,
        skillRange = { orange = 420, yellow = 430, green = 435, gray = 440 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 5 },
            { itemId = 42253, name = "Iceweb Spider Silk", count = 2 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
    ...
    -- Deathchill Cloak (420)
    {
        id = 56017,
        name = "Deathchill Cloak",
        itemId = 41610,
        skillRequired = 420,
        skillRange = { orange = 420, yellow = 435, green = 445, gray = 455 },
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 5 },
    ...
    -- Frostsavage Shoulders (420)
    {
        ...
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 3 },
            { itemId = 37702, name = "Crystallized Fire", count = 4 },
            { itemId = 37701, name = "Crystallized Earth", count = 4 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Frostsavage Robe (420)
    {
        ...
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 4 },
            { itemId = 37702, name = "Crystallized Fire", count = 5 },
            { itemId = 37701, name = "Crystallized Earth", count = 5 },
            { itemId = 38426, name = "Eternium Thread", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Magnificent Flying Carpet (425)
    {
        ...
        reagents = {
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 12 },
            { itemId = 36930, name = "Monarch Topaz", count = 4 },
            { itemId = 2604, name = "Red Dye", count = 4 },
            { itemId = 4341, name = "Yellow Dye", count = 2 },
            { itemId = 42253, name = "Iceweb Spider Silk", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Glacial Robe (425)
    {
        ...
        reagents = {
            ...
            { itemId = 38426, name = "Eternium Thread", count = 3 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Frosty Flying Carpet (425)
    {
        ...
        reagents = {
            ...
            { itemId = 41595, name = "Spellweave", count = 1 },
            { itemId = 41593, name = "Ebonweave", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.QUEST,
            itemId = 54798,
    ...
    -- Brilliant Spellthread (430)
    {
        ...
        itemId = 41602,
        skillRequired = 430,
        skillRange = { orange = 430, yellow = 435, green = 440, gray = 445 },
        reagents = {
    ...
    -- Abyssal Bag (435)
    {
        ...
        itemId = 41597,
        skillRequired = 435,
        skillRange = { orange = 435, yellow = 440, green = 445, gray = 450 },
        reagents = {
            { itemId = 41593, name = "Ebonweave", count = 4 },
            { itemId = 41595, name = "Spellweave", count = 2 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
    ...
    -- Moonshroud Gloves (435)
    {
        ...
        itemId = 42103,
        skillRequired = 435,
        skillRange = { orange = 435, yellow = 445, green = 450, gray = 455 },
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 4 },
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 4 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
    ...
    -- Spellweave Gloves (435)
    {
        ...
        skillRange = { orange = 435, yellow = 445, green = 450, gray = 455 },
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 4 },
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 4 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
    ...
    -- Emerald Bag (435)
    {
        ...
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 4 },
            { itemId = 36908, name = "Frost Lotus", count = 6 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
            factionId = 1073,
    ...
    -- Mysterious Bag (440)
    {
        ...
        itemId = 41598,
        skillRequired = 440,
        skillRange = { orange = 440, yellow = 445, green = 450, gray = 455 },
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 4 },
            { itemId = 41594, name = "Moonshroud", count = 2 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
    ...
    -- Moonshroud Robe (440)
    {
        ...
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 8 },
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 6 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
    ...
    -- Ebonweave Robe (440)
    {
        ...
        skillRange = { orange = 440, yellow = 450, green = 455, gray = 460 },
        reagents = {
            { itemId = 41593, name = "Ebonweave", count = 8 },
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 6 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
    ...
    -- Spellweave Robe (440)
    {
        ...
        skillRange = { orange = 440, yellow = 450, green = 455, gray = 460 },
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 8 },
            { itemId = 41511, name = "Bolt of Imbued Frostweave", count = 6 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
    ...
    -- Glacial Bag (445)
    {
        ...
        itemId = 41600,
        skillRequired = 445,
        skillRange = { orange = 445, yellow = 450, green = 455, gray = 460 },
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 4 },
            { itemId = 41593, name = "Ebonweave", count = 4 },
            { itemId = 38426, name = "Eternium Thread", count = 1 },
    ...
    -- Royal Moonshroud Robe (450)
    {
        ...
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 20 },
            { itemId = 36922, name = "King's Amber", count = 2 },
    ...
    -- Royal Moonshroud Bracers (450)
    {
        ...
        skillRange = { orange = 450, yellow = 460, green = 467, gray = 475 },
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 12 },
    ...
    -- Bejeweled Wizard's Bracers (450)
    {
        id = 67079,
    ...
    -- Leggings of Woven Death (450)
    {
        ...
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 10 },
            { itemId = 41593, name = "Ebonweave", count = 10 },
    ...
    -- Deathfrost Boots (450)
    {
        ...
        skillRange = { orange = 450, yellow = 475, green = 487, gray = 500 },
        reagents = {
            { itemId = 41595, name = "Spellweave", count = 6 },
            { itemId = 41593, name = "Ebonweave", count = 6 },
    ...
    -- Sandals of Consecration (450)
    {
        ...
        skillRange = { orange = 450, yellow = 475, green = 487, gray = 500 },
        reagents = {
            { itemId = 41594, name = "Moonshroud", count = 10 },
            { itemId = 49908, name = "Primordial Saronite", count = 5 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
