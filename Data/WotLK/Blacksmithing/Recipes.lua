-- Data/WotLK/Blacksmithing/Recipes.lua
-- Blacksmithing recipes for WotLK Classic
...
local recipes = {
    ...
    -- Shadow Crescent Axe (200)
    {
        ...
        reagents = {
            ...
            { itemId = 3824, name = "Shadow Oil", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
            itemId = 3869,
    ...
    -- Cobalt Chestpiece (375)
    {
        ...
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 6 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Spiked Cobalt Helm (375)
    {
        ...
        skillRange = { orange = 375, yellow = 380, green = 385, gray = 390 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 7 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Reinforced Cobalt Shoulders (375)
    {
        ...
        itemId = 40956,
        skillRequired = 375,
        skillRange = { orange = 375, yellow = 395, green = 400, gray = 405 },
        reagents = {
    ...
    -- Reinforced Cobalt Helm (375)
    {
        ...
        itemId = 40957,
        skillRequired = 375,
        skillRange = { orange = 375, yellow = 405, green = 410, gray = 415 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 8 },
            { itemId = 37705, name = "Crystallized Water", count = 2 },
        },
    ...
    -- Reinforced Cobalt Legplates (375)
    {
        ...
        itemId = 40958,
        skillRequired = 375,
        skillRange = { orange = 375, yellow = 410, green = 415, gray = 420 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 8 },
            { itemId = 37705, name = "Crystallized Water", count = 2 },
        },
    ...
    -- Reinforced Cobalt Chestpiece (375)
    {
        ...
        itemId = 40959,
        skillRequired = 375,
        skillRange = { orange = 375, yellow = 415, green = 420, gray = 425 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 8 },
            { itemId = 37705, name = "Crystallized Water", count = 2 },
        },
    ...
    -- Forged Cobalt Claymore (385)
    {
        ...
        skillRange = { orange = 385, yellow = 390, green = 395, gray = 400 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 10 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Spiked Cobalt Gauntlets (390)
    {
        ...
        skillRange = { orange = 390, yellow = 395, green = 400, gray = 405 },
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 12 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Saronite Ambusher (400)
    {
        ...
        reagents = {
            { itemId = 36916, name = "Cobalt Bar", count = 12 },
            { itemId = 36913, name = "Saronite Bar", count = 4 },
            { itemId = 37703, name = "Crystallized Shadow", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Deadly Saronite Dirk (405)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 7 },
            { itemId = 37700, name = "Crystallized Air", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Saronite Bulwark (410)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 14 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Tempered Saronite Bracers (410)
    {
        ...
        skillRange = { orange = 410, yellow = 415, green = 420, gray = 425 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 13 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Furious Saronite Beatstick (410)
    {
        ...
        skillRange = { orange = 410, yellow = 415, green = 420, gray = 425 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 15 },
    ...
    -- Corroded Saronite Edge (415)
    {
        ...
        skillRange = { orange = 415, yellow = 420, green = 425, gray = 430 },
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 16 },
            { itemId = 37702, name = "Crystallized Fire", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Titansteel Destroyer (440)
    {
        ...
        reagents = {
            ...
            { itemId = 43102, name = "Frozen Orb", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
            npcName = "Any Blacksmithing Trainer",
    ...
    -- Titansteel Bonecrusher (440)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 6 },
            { itemId = 37663, name = "Titansteel Bar", count = 6 },
            { itemId = 43102, name = "Frozen Orb", count = 2 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Spiked Titansteel Helm (440)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 4 },
            { itemId = 37663, name = "Titansteel Bar", count = 4 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Spiked Titansteel Treads (440)
    {
        ...
        reagents = {
            { itemId = 36913, name = "Saronite Bar", count = 4 },
            { itemId = 37663, name = "Titansteel Bar", count = 3 },
            { itemId = 43102, name = "Frozen Orb", count = 1 },
        },
        source = {
            type = C.SOURCE_TYPE.TRAINER,
    ...
    -- Belt of the Titans (450)
    {
        ...
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 5 },
    ...
    -- Plate Girdle of Righteousness (450)
    {
        id = 63189,
    ...
    -- Indestructible Plate Girdle (450)
    {
        id = 63191,
    ...
    -- Breastplate of the White Knight (450)
    {
        id = 67091,
        ...
        reagents = {
            ...
            { itemId = 36925, name = "Majestic Zircon", count = 2 },
    ...
    -- Titanium Razorplate (450)
    {
        ...
        skillRange = { orange = 450, yellow = 460, green = 467, gray = 475 },
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 10 },
            { itemId = 41245, name = "Deadly Saronite Dirk", count = 4 },
            { itemId = 47556, name = "Crusader Orb", count = 8 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
    ...
    -- Titanium Spikeguards (450)
    {
        ...
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 8 },
            { itemId = 41355, name = "Vengeance Bindings", count = 1 },
            { itemId = 47556, name = "Crusader Orb", count = 4 },
        },
        source = {
            type = C.SOURCE_TYPE.DROP,
    ...
    -- Puresteel Legplates (450)
    {
        ...
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 12 },
            { itemId = 35623, name = "Eternal Air", count = 20 },
    ...
    -- Protectors of Life (450)
    {
        ...
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 8 },
            { itemId = 35624, name = "Eternal Earth", count = 12 },
    ...
    -- Legplates of Painful Death (450)
    {
        id = 70565,
    ...
    -- Pillars of Might (450)
    {
        ...
        reagents = {
            { itemId = 37663, name = "Titansteel Bar", count = 12 },
            { itemId = 35624, name = "Eternal Earth", count = 20 },
            { itemId = 49908, name = "Primordial Saronite", count = 8 },
        },
        source = {
            type = C.SOURCE_TYPE.REPUTATION,
